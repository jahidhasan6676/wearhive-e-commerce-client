            ...
            <div className="grid lg:grid-cols-2 gap-10">
                ...
                <div className="bg-white rounded-md p-3 md:p-6 lg:p-10">
                    ...
                    <form className="mt-6 space-y-4">
                        ...
                        <input type="email" name="email" placeholder="Email address" className="input-field w-full" required />
                        <div className="grid grid-cols-2 gap-4">
                            <input type="text" name="phone" value={deliveryInfo.phone} onChange={handleInputChange} placeholder="Phone" className="input-field" required />
                            <input type="text" name="country" value={deliveryInfo.country} onChange={handleInputChange} placeholder="Country" className="input-field" required />
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <input type="text" name="city" value={deliveryInfo.city} onChange={handleInputChange} placeholder="City" className="input-field" required />
                            <input type="text" name="state" value={deliveryInfo.state} onChange={handleInputChange} placeholder="State" className="input-field" required />
                        </div>
                        <textarea name="description" value={deliveryInfo.description} onChange={handleInputChange} className="p-2 input-field" rows="3" placeholder="Enter address..." required></textarea>
                    </form>
                </div>
                ...
                <div className="bg-white rounded-md p-3 md:p-6 lg:p-10">
                    ...
                    <div className="mt-4 flex space-x-4">
                        <label className="border px-3 py-2 rounded-md flex justify-center items-center gap-2">
                            <input onClick={() => setPaymentMethod("stripe")} type="radio" name="payment" className="" />
                            <span className="text-purple-600 font-semibold">STRIPE</span>
                        </label>
                        <label className="border px-3 py-2 rounded-md flex justify-center items-center gap-2">
                            <input onClick={() => setPaymentMethod("sslCommerce")} type="radio" name="payment" className="" />
