                ...
                <div className="w-11/12 mx-auto flex justify-between items-center py-4">
                    ...
                    <div className="hidden md:block">
                        <ul className="flex items-center gap-6">
                            ...
                            {user?.email && <li><NavLink to="/dashboard" className={({ isActive }) => `font-medium text-[17px] ${isActive ? 'text-secondary' : 'hover:text-secondary'}`}>Dashboard</NavLink></li>}
                        </ul>
                    </div>
                    ...
                    >
                        <div className="relative w-full h-full p-6">
                            ...
                            <ul className="flex flex-col gap-4 mt-10">
                                ...
                                {user?.email && <li><NavLink to="/dashboard" className={({ isActive }) => `font-medium text-[17px] ${isActive ? 'text-secondary' : 'hover:text-secondary'}`} onClick={() => setOpen(false)}>Dashboard</NavLink></li>}
                            </ul>
                            <div className="mt-6">
                                {user ? (
