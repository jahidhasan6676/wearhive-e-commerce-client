                    ...
                    <SwiperSlide key={slide.id}>
                        <div className="relative w-full h-full">
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-center w-11/12 mx-auto">
                                <span className="text-[16px] md:text-lg font-medium text-white bg-white/20 px-4 py-1.5 rounded-full inline-block mb-6 w-fit backdrop-blur-sm border border-white/20">
                                    {slide.subtitle}
                                </span>
                                <h2 className="text-2xl md:text-4xl lg:text-6xl font-bold text-white mb-6 leading-tight tracking-tight">
                                    {slide.title}
                                </h2>
                                ...
                                <Link
                                    to={slide.link}
                                    className="inline-flex items-center px-3 py-2 md:px-6 md:py-3 lg:px-8 lg:py-4 bg-white text-gray-900 rounded-full font-semibold text-lg hover:bg-gray-900 hover:text-white transition-all duration-300 shadow-xl w-fit group border-2 border-white"
                                >
                                    {slide.cta}
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2 md:ml-3 group-hover:translate-x-2 transition-transform" viewBox="0 0 20 20" fill="currentColor">
