                    ...
                    <SwiperSlide key={slide.id}>
                        <div className="relative w-full h-full">
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-center w-11/12 mx-auto">
                                ...
                                <Link
                                    to={slide.link}
                                    className=" relative inline-flex items-center overflow-hidden font-semibold text-gray-900 bg-white text-lg px-3 py-2 md:px-6 md:py-3 lg:px-8 lg:py-4 group border-2 border-white shadow-xl rounded-full w-fit transition-all duration-500 
